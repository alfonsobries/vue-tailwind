const BootstrapTheme = {
  ...
  TButton: {
    defaultClass: 'border block w-full rounded bg-white border-gray-400 hover:bg-gray-100 hover:border-gray-500',
    primaryClass: 'border block w-full rounded text-white bg-blue-500 border-blue-500 hover:bg-blue-600 hover:border-blue-600',
    secondaryClass: 'border block w-full rounded border-blue-500 text-blue-500 bg-white hover:border-blue-600 hover:text-blue-600 hover:bg-white',
    tertiaryClass: 'border block w-full underline text-blue-500 border-transparent bg-transparent hover:text-blue-600',
    successClass: 'border block w-full rounded text-white bg-green-500 border-green-500 hover:bg-green-600 hover:border-green-600',
    dangerClass: 'border block w-full rounded text-white bg-red-500 border-red-500 hover:bg-red-600 hover:border-red-600',
    warningClass: 'border block w-full rounded text-yellow-900 bg-yellow-500 border-yellow-500 hover:bg-yellow-600 hover:border-yellow-600',
