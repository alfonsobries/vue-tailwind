    ...
    classes: {
      ...
      default() {
        return {
          wrapper: '',
          buttonWrapper: '',
          selectButton: 'px-3 py-2 text-black transition duration-100 ease-in-out bg-white border border-gray-300 rounded shadow-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500 focus:outline-none focus:ring-opacity-50',
          selectButtonLabel: '',
          selectButtonPlaceholder: 'text-gray-400',
          selectButtonIcon: 'text-gray-400',
          selectButtonClearButton: 'hover:bg-gray-100 text-gray-400 rounded transition duration-100 ease-in-out',
          selectButtonClearIcon: '',
          dropdown: '-mt-1 absolute bg-white border-b border-gray-300 border-l border-r rounded-b shadow-sm w-full z-10',
          dropdownFeedback: 'pb-2 px-3 text-gray-400 text-sm',
          loadingMoreResults: 'pb-2 px-3 text-gray-400 text-sm',
          optionsList: '',
          searchWrapper: 'bg-white p-2 placeholder-gray-400',
