...
import TDatePickerMonthsMonthDaysDay from './TDatePickerMonthsMonthDaysDay';

const TDatePickerMonthsMonthDays = Vue.extend({
  name: 'TDatePickerMonthsMonthDays',
...
export default TDatePickerMonthsMonthDays;
