    ...
    classes: {
      ...
      default() {
        return {
          ...
          selectButtonClearIconWrapper: 'hover:bg-red-200 rounded flex h-5 w-5 flex-shrink-0 items-center justify-center ml-1 ',
          selectButtonClearIcon: 'fill-current h-3 w-3 text-red-500',
